...
public class UICronTriggerAction extends ScheduleBase {
	...
	public String execute() throws ParseException {
		...
		CronTrigger cronTrigger = new CronTrigger(getTriggerName(), getTriggerGroup());
		// all weird constraints are handled by the validate method

		cronTrigger.setJobGroup(this.getJobGroup());
		cronTrigger.setJobName(this.getJobName());
		cronTrigger.setDescription(this.getDescription());
