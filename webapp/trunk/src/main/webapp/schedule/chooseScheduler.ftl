...
<#if scheduleInfo.scheduler?exists>	
	...
	<span id="controls">
	<button name="play" value="start" type="submit"><img type="image"  value="start" src="${base}/icons/Play24.gif" alt="Start Scheduler" /></button>
	<button name="pause" value="pause" type="submit"><img type="image" value="pause" src="${base}/icons/Pause24.gif"  alt="Pause Scheduler" /></button> 
	<button name="stop" value="stop" type="submit"><img type="image" value="stop" src="${base}/icons/Stop24.gif"  alt="Stop Scheduler" /></button>
	<button name="waitAndStop" value="waitAndStopScheduler" type="submit"><img type="image" value="waitAndStopScheduler" src="${base}/icons/Stop24.gif"   alt="Stop scheduler (wait for jobs to complete)" /> &nbsp;</button>
	</span>
	<br/>
